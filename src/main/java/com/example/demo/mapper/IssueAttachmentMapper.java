...
public interface IssueAttachmentMapper {
    ...
    @Insert({
        ...
        "#{from_id,jdbcType=BIGINT}, #{issue_id,jdbcType=BIGINT}, ",
        ...
        "#{status,jdbcType=INTEGER}, #{from_type,jdbcType=INTEGER})"
    })
    ...
    @Select({
        "select",
        "id, attachment_type, from_id, issue_id, attachment_url, creator, created_by, ",
        "created, modified_by, modified, status, from_type",
    ...
    @ConstructorArgs({
        ...
        @Arg(column="from_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
        ...
        @Arg(column="from_type", javaType=Integer.class, jdbcType=JdbcType.INTEGER)
    })
    IssueAttachment selectByPrimaryKey(Long id);


    @SelectProvider(type=IssueAttachmentSqlProvider.class, method="getItems")
    List<IssueAttachment> getItems(IssueAttachment record);
    ...
    @Update({
        ...
        "set attachment_type = #{attachment_type,jdbcType=INTEGER},",
          "from_id = #{from_id,jdbcType=BIGINT},",
          ...
          "from_type = #{from_type,jdbcType=INTEGER}",
        "where id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
            "update issue_attachment",
            "set status = #{status}",
            "where creator = #{creator} and issue_id = #{issue_id} and",
            "from_type = #{from_type} and from_id = #{from_id} and attachment_url = #{attachment_url}"
    })
    int setStatus(IssueAttachment record);
}